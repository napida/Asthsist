            ...
            {score >= 0 && score <= 15 ?
                ...
                : score > 15 && score <= 20 ?
                    <ZoneCard
                        ...
                        textContent='A total score of 16-20 on the Asthma Control Test indicates room for improvement in your asthma control. Work with your healthcare provider to develop a plan to improve your score and breathe easier.'
                        buttonLabel='Back to home'
                        onPress={() => navigation.reset({
                            index: 0,
                            routes: [{ name: 'Asthsist'}],
                    ...
                    : score > 20 && score <= 25 ?
                        <ZoneCard
                            ...
                            textContent={`A total score of 21-25 on the Asthma Control Test means you have well-controlled asthma. Keep up the good work and continue to communicate with your healthcare provider for optimal management.`}
                            buttonLabel='Back to home'
                            onPress={() => navigation.reset({
                                index: 0,
                                routes: [{ name: 'Asthsist'}],
